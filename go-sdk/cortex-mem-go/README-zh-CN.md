...
[Cortex CE](https://github.com/abforce/cortex-ce) 的 Go 客户端库 —— AI 助手的持久记忆系统。
...
- **全面测试** —— 308 个单元测试，含 Wire 格式验证（client 218 + dto 54 + genkit 14 + langchaingo 13 + eino 9；集成包需从各自目录运行）
