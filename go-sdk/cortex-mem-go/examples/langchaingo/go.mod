module github.com/abforce/cortex-ce/cortex-mem-go/examples/langchaingo

go 1.22

require (
	github.com/abforce/cortex-ce/cortex-mem-go v0.0.0
	github.com/abforce/cortex-ce/cortex-mem-go/langchaingo v0.0.0-00010101000000-000000000000
)
