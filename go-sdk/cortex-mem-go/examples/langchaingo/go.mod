module github.com/Blueforce-Tech-Inc/BlueCortexCE/go-sdk/cortex-mem-go/examples/langchaingo

go 1.22

require (
	github.com/Blueforce-Tech-Inc/BlueCortexCE/go-sdk/cortex-mem-go v0.0.0
	github.com/Blueforce-Tech-Inc/BlueCortexCE/go-sdk/cortex-mem-go/langchaingo v0.0.0-00010101000000-000000000000
)
