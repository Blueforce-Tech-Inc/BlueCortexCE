...
- **Comprehensive tests** — 303 unit tests with wire format verification (client 217 + dto 53 + genkit 13 + langchaingo 12 + eino 8; integration packages must be run from their own directories)
