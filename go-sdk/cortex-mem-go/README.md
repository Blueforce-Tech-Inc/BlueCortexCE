...
- **Comprehensive tests** — 308 unit tests with wire format verification (client 218 + dto 54 + genkit 14 + langchaingo 13 + eino 9; integration packages must be run from their own directories)
