...
| **ATP TaskPickup+Execute+Heartbeat+Adapters 深度**（Ledger防重/原子写/幂等哈希/HMAC签名/sessions_spawn隔离契约/heartbeat旁路交付/共享Ledger双消费者/markerKey干净卸载） | [`125`](./125-atp-taskpickup-execute-heartbeat-adapters-deep-dive.md) |
