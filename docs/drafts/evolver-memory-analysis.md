...
| 记忆 HTTP + 数据平面（**§1.1** `semantic` · §2 写入 · **§3.1** `workerHttpRequest`） | [docs/drafts/evolver-memory/12-bluecortex-api-memory-surface.md](./evolver-memory/12-bluecortex-api-memory-surface.md) |
