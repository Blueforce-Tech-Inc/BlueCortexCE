# 矛盾检测工程方案 + Session Tools 分析

> **来源拆分**：本文件从 [`07-bluecortexce-contradiction-detection-plan.md`](07-bluecortexce-contradiction-detection-plan.md) 拆分而来（原文 §45–§52 已迁入本文，§44–§45 RetainDB/Supermemory 迁入 [`29`](29-memory-provider-hooks-advanced-topics.md)）。
> **体量**：约 32.4KB ≪ 50KB 上限。
